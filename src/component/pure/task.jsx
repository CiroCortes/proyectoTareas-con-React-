...
const TaskComponent = ({ task, complete, remove }) => {
    ...
    //aplicamos estilos a traves de ccs como objetos, para que la tarea pinte dependiendo del estado
    // para estilar dentro de las const, debemos omitir los guiones y usar el camelCase, y pasar el parametro como cadena de texto
